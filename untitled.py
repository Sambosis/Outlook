...
class untitled(App):
    ...
    def construct_ui(self):
        #DON'T MAKE CHANGES HERE, THIS METHOD GETS OVERWRITTEN WHEN SAVING IN THE EDITOR
        dropdownitem0 = DropDownItem()
        dropdownitem0.attr_class = "DropDownItem"
        dropdownitem0.attr_editor_newclass = False
        dropdownitem0.text = "drop down item"
        dropdownitem0.value = "drop down item"
        dropdownitem0.variable_name = "dropdownitem0"
        

        self.dropdownitem0 = dropdownitem0
        return self.dropdownitem0
